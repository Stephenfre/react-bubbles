...
- [ ] Explain what a token is used for.
  ...
  <!-- Tokens are strings of cryptic text, which can be stored on the client-side using local storage or session storage. The server can tell the client that it issued the token. It can also read the token and make data transfer based on the client’s permission. -->

- [ ] What steps can you take in your web apps to keep your data secure?

  <!-- We can use “protected” routes that would only render with authentication. Normally, the client will make a login request, sending the server the user’s username and password. The server will check the credentials against the database, and if the user can be authenticated, it will return a token.  -->

- [ ] Describe how web servers work.

  <!-- It stores the code for different websites to be shared across the world at all times -->
